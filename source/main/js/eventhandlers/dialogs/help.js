...
// The help dialogs has no need for a specific
// handler. The general addEventListener handles
// the Cancel/Close button (closing the dialog).
// Therefore an 'undefined', handler function can
// be used.

window.addEventListener("load", function () {
    addDialogEventListener("help-content", undefined)
});

window.addEventListener("load", function () {
    addDialogEventListener("help-about", undefined)
});
